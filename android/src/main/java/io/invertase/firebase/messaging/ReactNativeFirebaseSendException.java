...
//
//public class ReactNativeFirebaseSendException {
//}
////
...
public final class ReactNativeFirebaseSendException extends Exception {
  ...
  ReactNativeFirebaseSendException(String var1) {
    super(var1);
